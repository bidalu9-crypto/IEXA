...
.method static constructor <clinit>()V
    ...
    sput-object v0, Ln1/c;->b:LA/Z;

    return-void
.end method

.method public static a(Landroid/content/Context;Ljava/util/List;)LA4/q;
    .locals 5
    ...
    invoke-static {v3, v2, v4}, Ln1/c;->b(Landroid/content/pm/PackageManager;Ln1/d;Landroid/content/res/Resources;)Landroid/content/pm/ProviderInfo;
    ...
    invoke-direct {p0, p1}, LA4/q;-><init>(I)V
    :try_end_0
    ...
    invoke-static {p0, v2, v3}, Ln1/c;->c(Landroid/content/Context;Ln1/d;Ljava/lang/String;)[Ln1/i;
    ...
    invoke-direct {p0, p1, v0}, LA4/q;-><init>(ILjava/util/ArrayList;)V
    :try_end_1
...
.method public static b(Landroid/content/pm/PackageManager;Ln1/d;Landroid/content/res/Resources;)Landroid/content/pm/ProviderInfo;
    .locals 9
    ...
    invoke-static {v2}, LN1/a;->q0(Ljava/lang/String;)V

    :try_start_0
    iget-object v2, p1, Ln1/d;->d:Ljava/util/List;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    iget-object v3, p1, Ln1/d;->a:Ljava/lang/String;
    ...
    :cond_0
    :try_start_1
    invoke-static {p2, v4}, LN1/a;->M0(Landroid/content/res/Resources;I)Ljava/util/List;
    ...
    iput-object v3, p2, Ln1/b;->a:Ljava/lang/String;

    iput-object p1, p2, Ln1/b;->b:Ljava/lang/String;

    iput-object v2, p2, Ln1/b;->c:Ljava/util/List;
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0

    sget-object v5, Ln1/c;->a:Lm/v;

    :try_start_2
    invoke-virtual {v5, p2}, Lm/v;->b(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    :cond_5
    invoke-virtual {v5, p2, v6}, Lm/v;->c(Ljava/lang/Object;Ljava/lang/Object;)V
    :try_end_4
...
.method public static c(Landroid/content/Context;Ln1/d;Ljava/lang/String;)[Ln1/i;
    .locals 20
    ...
    iget-object v0, v0, Ln1/d;->c:Ljava/lang/String;
    ...
    invoke-direct/range {v14 .. v19}, Ln1/i;-><init>(Landroid/net/Uri;IIZI)V
