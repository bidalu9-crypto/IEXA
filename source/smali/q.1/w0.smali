...
# static fields
.field public static final a:Lq/w0;
...
# virtual methods
.method public final a(Landroid/view/View;ZJFFZLZ0/c;F)Lq/r0;
    .locals 2
    ...
    invoke-direct {p2, p3}, Lq/t0;-><init>(Landroid/widget/Magnifier;)V

    goto :goto_0

    :cond_0
    invoke-interface {p8, p3, p4}, LZ0/c;->C(J)J

    move-result-wide p2

    invoke-interface {p8, p5}, LZ0/c;->I(F)F

    move-result p4

    invoke-interface {p8, p6}, LZ0/c;->I(F)F
    ...
    invoke-direct {p2, p1}, Lq/t0;-><init>(Landroid/widget/Magnifier;)V
