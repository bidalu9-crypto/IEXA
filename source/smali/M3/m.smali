...
.method public static final B(LM3/c;)LM3/c;
    .locals 6

    new-instance v0, LM3/c;

    iget-object v1, p0, LM3/c;->a:Ljava/io/File;
    ...
    :cond_3
    invoke-direct {v0, v1, v2}, LM3/c;-><init>(Ljava/io/File;Ljava/util/List;)V
...
.method public static C(Ljava/io/File;)[B
    ...
    invoke-static {v0, v6, v5}, Ly2/a;->e(Ljava/io/InputStream;Ljava/io/OutputStream;I)J
    ...
    invoke-static {v1, v3, v4, p0, v2}, LB3/l;->B(III[B[B)V
    :try_end_2
    ...
    invoke-static {v0, p0}, LE4/d;->c(Ljava/io/Closeable;Ljava/lang/Throwable;)V
...
.method public static D(Ljava/io/File;)Ljava/lang/String;
    ...
    :try_start_0
    invoke-static {v1}, LB3/o;->L(Ljava/io/Reader;)Ljava/lang/String;
    ...
    invoke-static {v1, p0}, LE4/d;->c(Ljava/io/Closeable;Ljava/lang/Throwable;)V
...
.method public static E(Ljava/io/File;)Ljava/io/File;
    ...
    invoke-static {v1}, LE4/l;->o(Ljava/lang/String;)I
    ...
    invoke-static {p0, v1}, LZ3/o;->B0(Ljava/lang/String;C)Z
...
.method public static final F(Ljava/io/File;Ljava/io/File;)Ljava/lang/String;
    ...
    invoke-static {p0}, LE4/l;->u(Ljava/io/File;)LM3/c;

    move-result-object v0

    invoke-static {v0}, LM3/m;->B(LM3/c;)LM3/c;

    move-result-object v0

    invoke-static {p1}, LE4/l;->u(Ljava/io/File;)LM3/c;

    move-result-object v1

    invoke-static {v1}, LM3/m;->B(LM3/c;)LM3/c;

    move-result-object v1

    iget-object v2, v0, LM3/c;->a:Ljava/io/File;

    iget-object v3, v1, LM3/c;->a:Ljava/io/File;
    ...
    :cond_5
    invoke-static {v0, v6}, LB3/n;->e0(Ljava/lang/Iterable;I)Ljava/util/List;
    ...
    invoke-static {v0, v5, v1, v3, v2}, LB3/n;->m0(Ljava/util/List;Ljava/lang/StringBuilder;Ljava/lang/String;LP/J2;I)V
...
.method public static G(Ljava/io/File;)LM3/k;
    .locals 4
    ...
    invoke-direct {v1, p0, v0, v2, v3}, LM3/k;-><init>(Ljava/io/File;LM3/l;LM3/o;I)V
...
.method public static I(Ljava/io/File;Ljava/lang/String;Ljava/nio/charset/Charset;)V
    ...
    :try_start_0
    invoke-static {v0, p1, p2}, LM3/m;->K(Ljava/io/FileOutputStream;Ljava/lang/String;Ljava/nio/charset/Charset;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public static synthetic J(Ljava/io/File;Ljava/lang/String;)V
    .locals 1

    sget-object v0, LZ3/a;->a:Ljava/nio/charset/Charset;

    invoke-static {p0, p1, v0}, LM3/m;->I(Ljava/io/File;Ljava/lang/String;Ljava/nio/charset/Charset;)V
...
.method public static w(Ljava/io/File;Ljava/lang/String;)V
    ...
    :try_start_0
    invoke-static {v1, p1, v0}, LM3/m;->K(Ljava/io/FileOutputStream;Ljava/lang/String;Ljava/nio/charset/Charset;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public static x(Ljava/io/File;Ljava/io/File;)V
    ...
    invoke-direct {v3, v4, v0}, LM3/o;-><init>(ILjava/lang/Object;)V

    new-instance v4, LM3/k;

    iget-object v5, v1, LM3/k;->a:Ljava/io/File;

    iget-object v1, v1, LM3/k;->b:LM3/l;

    const v6, 0x7fffffff

    invoke-direct {v4, v5, v1, v3, v6}, LM3/k;-><init>(Ljava/io/File;LM3/l;LM3/o;I)V

    new-instance v1, LM3/i;

    invoke-direct {v1, v4}, LM3/i;-><init>(LM3/k;)V
    ...
    invoke-static {v3, p0}, LM3/m;->F(Ljava/io/File;Ljava/io/File;)Ljava/lang/String;
    ...
    invoke-direct {p0, v3, v5, p1}, LM3/d;-><init>(Ljava/io/File;Ljava/io/File;Ljava/lang/String;)V

    invoke-virtual {v0, v5, p0}, LM3/p;->g(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-static {v3, v5, v4}, LM3/m;->y(Ljava/io/File;Ljava/io/File;Z)V
    ...
    invoke-virtual {v0, v3, p0}, LM3/p;->g(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-direct {p0, v3, p1}, LM3/a;-><init>(Ljava/io/File;I)V

    invoke-virtual {v0, v3, p0}, LM3/p;->g(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    throw v2
    :try_end_0
    .catch LM3/s; {:try_start_0 .. :try_end_0} :catch_0
    ...
    invoke-direct {p1, p0, v1}, LM3/a;-><init>(Ljava/io/File;I)V

    invoke-virtual {v0, p0, p1}, LM3/p;->g(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
...
.method public static y(Ljava/io/File;Ljava/io/File;Z)V
    ...
    invoke-direct {p2, p0, p1, v0}, LM3/d;-><init>(Ljava/io/File;Ljava/io/File;Ljava/lang/String;)V
    ...
    :try_start_1
    invoke-static {p2, p0, p1}, Ly2/a;->e(Ljava/io/InputStream;Ljava/io/OutputStream;I)J
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_1
    ...
    invoke-static {p2, p0}, LE4/d;->c(Ljava/io/Closeable;Ljava/lang/Throwable;)V
    ...
    invoke-direct {p1, p0, p2}, LM3/a;-><init>(Ljava/io/File;I)V
...
.method public static z(Ljava/io/File;)Z
    ...
    invoke-direct {p0, v1}, LM3/i;-><init>(LM3/k;)V
    ...
    invoke-virtual {p0}, LM3/i;->next()Ljava/lang/Object;
