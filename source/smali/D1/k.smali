...
.method public static b()LB1/h;
    ...
    invoke-virtual {v2, v1, v3, v0}, LO2/j;->s(Le1/g;Ljava/lang/Object;Ljava/lang/Object;)Z

    move-result v0

    if-eqz v0, :cond_0

    invoke-static {v1}, Le1/g;->b(Le1/g;)V

    :cond_0
    sget-object v0, LD1/k;->c:LB1/h;
...
.method public static c(Landroid/content/Context;Z)V
    ...
    :try_start_9
    invoke-static {v3}, LD1/j;->a(Ljava/io/File;)LD1/j;
    ...
    iget-wide v11, v9, LD1/j;->c:J

    cmp-long v11, v11, v15

    if-nez v11, :cond_9

    iget v11, v9, LD1/j;->b:I
    ...
    iget v0, v9, LD1/j;->b:I

    if-ne v0, v10, :cond_e

    if-ne v5, v4, :cond_e

    iget-wide v10, v9, LD1/j;->d:J
    ...
    invoke-direct/range {v12 .. v18}, LD1/j;-><init>(IIJJ)V

    if-eqz v9, :cond_f

    invoke-virtual {v9, v0}, LD1/j;->equals(Ljava/lang/Object;)Z
    ...
    :cond_f
    :try_start_b
    invoke-virtual {v0, v3}, LD1/j;->b(Ljava/io/File;)V
    :try_end_b
