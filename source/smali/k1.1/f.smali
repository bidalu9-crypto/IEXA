...
# direct methods
.method public static t0(Landroid/graphics/fonts/FontFamily;)Landroid/graphics/fonts/Font;
    .locals 6
    ...
    invoke-static {v0, v2}, Lk1/f;->v0(Landroid/graphics/fonts/FontStyle;Landroid/graphics/fonts/FontStyle;)I
    ...
    invoke-static {v0, v5}, Lk1/f;->v0(Landroid/graphics/fonts/FontStyle;Landroid/graphics/fonts/FontStyle;)I
...
.method public static u0([Ln1/i;Landroid/content/ContentResolver;)Landroid/graphics/fonts/FontFamily;
    .locals 8
    ...
    :try_start_0
    iget-object v5, v4, Ln1/i;->a:Landroid/net/Uri;
    ...
    iget v7, v4, Ln1/i;->c:I

    invoke-virtual {v6, v7}, Landroid/graphics/fonts/Font$Builder;->setWeight(I)Landroid/graphics/fonts/Font$Builder;

    move-result-object v6

    iget-boolean v7, v4, Ln1/i;->d:Z

    invoke-virtual {v6, v7}, Landroid/graphics/fonts/Font$Builder;->setSlant(I)Landroid/graphics/fonts/Font$Builder;

    move-result-object v6

    iget v4, v4, Ln1/i;->b:I
...
.method public static v0(Landroid/graphics/fonts/FontStyle;Landroid/graphics/fonts/FontStyle;)I
    .locals 2
...
.method public final P(Landroid/content/Context;Lj1/b;Landroid/content/res/Resources;)Landroid/graphics/Typeface;
    ...
    invoke-static {p2}, Lk1/f;->t0(Landroid/graphics/fonts/FontFamily;)Landroid/graphics/fonts/Font;
...
.method public final Q(Landroid/content/Context;[Ln1/i;)Landroid/graphics/Typeface;
    ...
    :try_start_0
    invoke-static {p2, p1}, Lk1/f;->u0([Ln1/i;Landroid/content/ContentResolver;)Landroid/graphics/fonts/FontFamily;
    ...
    invoke-static {p1}, Lk1/f;->t0(Landroid/graphics/fonts/FontFamily;)Landroid/graphics/fonts/Font;
...
.method public final R(Landroid/content/Context;Ljava/util/List;)Landroid/graphics/Typeface;
    .locals 5
    ...
    invoke-static {v0, p1}, Lk1/f;->u0([Ln1/i;Landroid/content/ContentResolver;)Landroid/graphics/fonts/FontFamily;
    ...
    invoke-static {v4, p1}, Lk1/f;->u0([Ln1/i;Landroid/content/ContentResolver;)Landroid/graphics/fonts/FontFamily;
    ...
    :cond_2
    invoke-static {v0}, Lk1/f;->t0(Landroid/graphics/fonts/FontFamily;)Landroid/graphics/fonts/Font;
...
.method public final Z([Ln1/i;)Ln1/i;
    .locals 1
